...
svn co https://github.com/NoTengoBattery/openwrt/branches/linksys-ea6350v3-mastertrack/feeds/luci/applications/luci-app-compressed-memory feeds/luci/applications/luci-app-compressed-memory
#更换cryptodev-linux
